...
> {
  ...
  private static sharedInstance: RewardedInterstitialAd | null = null;

  private static checkInstance() {
    if (!this.sharedInstance) {
      throw new Error('RewardedInterstitial is not created.');
    }
  }
  /**
  ...
  static createAd(unitId: string, options?: FullScreenAdOptions) {
    ...
    this.sharedInstance = new RewardedInterstitialAd(requestId, unitId, _options);
